...
cols = ['Last Name', 'First Name', 'Full Name', 'Cntry', 'Position', 'GP', 'G', 'A', 'PTS', 'Salary','Cap Hit']
...
x = st.sidebar.selectbox('Choose variable in X-axis', cols, index=10)
# cols = [i for i in cols if i != x]
# x = options[0]
y = st.sidebar.selectbox('Choose variable in Y-axis', cols, index=8)
# y = options[1]
color = st.sidebar.selectbox('Choose variable in Color-axis', cols, index=3)
# color = options[2]
